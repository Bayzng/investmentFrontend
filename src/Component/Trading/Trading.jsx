...
export default function Trading() {
  ...
  // NEW: withdraw modal + wallet state
...
const executeTrade = async (tradeId) => {
  ...
  // --- NEW: handle withdraw submit (sends wallet address to crypto.cryptofi@gmail.com)
        ...
        >
          ...
          >
            ...
            <p className="withdraw-note">
              <strong>Note:</strong> Ensure this is a CELO USDT-compatible address. Incorrect addresses may lead to irreversible loss.
            </p>

            <div className="withdraw-actions">
              <button className="btn" onClick={handleWithdrawSubmit}>
                Submit Withdrawal
              </button>
              <button
                className="btn ghost"
